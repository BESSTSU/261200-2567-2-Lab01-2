...
public class Turtle implements Runnable, ActionListener, MouseListener, MouseMotionListener, KeyListener, ComponentListener, MouseWheelListener
{
    ...
    public static void main(String[] a) {
        ...
        bob.width(5);
        bob.speed(2);
        bob.forward(120);    // move 30 units (pen down = draw a line)
        bob.left(90);
        bob.forward(40);    // move 30 units (pen down = draw a line)
        bob.left(90);
        bob.forward(120);// move 30 units (pen down = draw a line)
        bob.left(90);
        bob.forward(40);// move 30 units (pen down = draw a line)
        ...
        bob.forward(40);// move 30 units (pen down = draw a line)
        bob.right(45);
        bob.forward(21.21);// move 30 units (pen down = draw a line)
        bob.right(90);
        bob.forward(21.21);// move 30 units (pen down = draw a line)
        bob.left(135);
